...
import { Upload, message, Button, Divider, Input } from 'antd';
...
const ChartEditor = () => {
  ...
  // 
    ...
    }, [customChart, operationsMap, data, dataAvailable, commands, configCommands])
    ...
    return (
        <div className="main">
          ...
          {displayCommandBar && <div className="commandBar">
            ...
            <Input autoFocus placeholder="Input your command here." onPressEnter={(e) => submitCommand(e)}/>          
          </div>}
        </div>
    );
};
